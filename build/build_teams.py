  ...
  <div class="wrap split">
    ...
    <div>
      ...
      <div class="tile" style="margin-top:1.2rem">
        ...
        <p>Pickup and open play run all week around Vancouver, outdoors for free and indoors for a few dollars. No team, no season, just turn up and play.</p>
        <div class="foot"><a class="btn sm" href="open-play.html">Find a pickup game</a></div>
      </div>
    </div>
  </div>
</section>
...
<section>
  <div class="wrap split">
    <div>
      ...
      <p class="small" style="margin-top:.9rem">The league publishes the full, live table on its own site. <a href="https://www.ccisoccer.com/#1726772897523-6070d045-1090" rel="noopener" target="_blank">See the current standings at Clark County Indoor Sports</a>.</p>
    </div>
    <div>
