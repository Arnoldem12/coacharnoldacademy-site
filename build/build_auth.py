  ...
  <div class="wrap-n">
    ...
    <div id="pane-signin">
      ...
      <div class="notice" style="margin-top:1.6rem">
        ...
        <p>This preview uses local accounts so every screen can be tested before a real login system is connected. Password for all three is <code>REMOVED</code>.</p>
...
(function(){
  ...
  C.$$('[data-demo]').forEach(function(b){
    b.addEventListener('click',function(){
      ...
      document.getElementById('si-pass').value='REMOVED';
