  ...
  <div class="wrap split">
    <div>
      ...
      <div class="head"><span class="rule"></span><h2>Coaching experience</h2></div>
            <p>Arnold holds the full set of US Soccer Grassroots coaching licences, all the way through 11v11, and completes SafeSport training and background screening. Documentation is available to parents on request.</p>
    ...
    <div>
      <div class="tile" style="margin-bottom:1.2rem">
        ...
        <ul style="padding-left:1.1rem;font-size:.96rem">
          ...
          <li>US Soccer Grassroots coaching licences, up to and including 11v11</li>
      ...
      <div class="tile" style="margin-bottom:1.2rem">
        ...
        <p class="small muted" style="margin-top:.7rem">See more in the <a href="gallery.html">gallery</a>, and watch the <a href="videos.html">training videos</a> to see how sessions actually run.</p>
      </div>
