...
window.CAA_DATA = {
  ...
  demoUsers: [
    { email:"player@demo.test",  pass:"REMOVED", role:"player", name:"Sam Whitfield", teams:["obsidian-ac"] },
    { email:"parent@demo.test",  pass:"REMOVED", role:"parent", name:"Dana Whitfield", children:[{name:"Jordan Whitfield", age:11, team:"caa-u12"},{name:"Ellie Whitfield", age:8, team:null}] },
    { email:"coach@demo.test",   pass:"REMOVED", role:"coach",  name:"Arnold Eoka Mambe" }
  ]
};
