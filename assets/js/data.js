...
window.CAA_DATA = {
  ...
  site: {
    ...
    email: "coach@coacharnoldacademy.com",          // REPLACED
    phone: "+1 (509) 761-4386",                      // REPLACED
    whatsapp: "15097614386",                         // REPLACED digits only, no +
    ...
    ga4: "G-D5J85BW2BJ",                 // GA4 measurement ID. Analytics only loads if this is set AND the visitor accepted analytics cookies.
    searchConsole: ""
  },
  ...
  demoUsers: [
    { email:"coach@coacharnoldacademy.com", pass:"REMOVED", role:"coach", name:"Arnold (Owner, Coach Arnold Academy)", teams:["obsidian-ac"] }
  ]
};
